      ...
      <header className="sticky top-0 z-30 bg-white border-b shadow-sm">
        <div className="container flex items-center justify-between h-16 px-4 md:px-6">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link to="/" className="flex flex-col items-center text-solvy-gray hover:text-solvy-blue transition-colors">
              <Home size={20} />
              <span className="text-xs mt-1">Home</span>
            </Link>
            <Link to="/search" className="flex flex-col items-center text-solvy-gray hover:text-solvy-blue transition-colors">
              <Search size={20} />
              <span className="text-xs mt-1">Cerca</span>
            </Link>
            <Link to="/chat" className="flex flex-col items-center text-solvy-gray hover:text-solvy-blue transition-colors">
              <MessageSquare size={20} />
              <span className="text-xs mt-1">Chat</span>
            </Link>
            <Link to="/profile" className="flex flex-col items-center text-solvy-gray hover:text-solvy-blue transition-colors">
              <User size={20} />
      ...
      >
        <div className={cn(
          ...
          <nav className="flex flex-col gap-2">
            ...
            <Button 
              className="mt-4 bg-solvy-blue hover:bg-solvy-blue/90"
              onClick={() => setNavOpen(false)}
            >
              Nuova Richiesta
            </Button>
